/*=========================================
 ...
 Date: Jan 12, 2025
 Purpose: Build and populate the database
 that will be used for our website in
 the CSE340 class at BYU-Idaho
 =========================================*/
-- ========================================
-- Section: Database Creation
-- ========================================
-- Create account types
-- !IMPORTANT! Change owner when pushing to class database!
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO drago;
...
-- ========================================
-- Section: Queries to fix issues with data
-- ========================================
-- Query 4
